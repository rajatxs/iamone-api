...
const clink_interface_1 = require("../clink/clink.interface");
let TemplateService = class TemplateService extends AppTemplate_1.AppTemplate {
    constructor(userService, socialRefService, socialServiceProvider, clinkService) {
        super({ rootPath: (0, path_1.join)(__dirname, '..', '..', 'templates') });
